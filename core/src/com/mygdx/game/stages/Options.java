...
public class Options extends ScreenAdapter {
    ...
    public Options(final SOSGame game)
    {
        ...
        optionsImage.setPosition((SOSGame.WIDTH/100)*15,(SOSGame.HEIGHT/100)*85);
        ...
        optionsTitle.setPosition((optionsImage.getX()*6)/2,(optionsImage.getY()+(optionsImage.getHeight()/5)));
