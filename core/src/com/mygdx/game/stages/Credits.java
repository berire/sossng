...
public class Credits extends ScreenAdapter {
    ...
    public Credits(final SOSGame game)
    {
        ...
        creditsImage.setPosition((SOSGame.WIDTH/100)*15,(SOSGame.HEIGHT/100)*85);
        ...
        creditsTitle.setPosition((creditsImage.getX()*6)/2,(creditsImage.getY()+(creditsImage.getHeight()/5)));

        credits_label=new Label(credits_text,labelStyle);
        credits_label.setFontScale(1);
        credits_label.setSize((SOSGame.WIDTH/100)*60,credits_label.getMinHeight());
        credits_label.setWrap(false);
        credits_label.setPosition((SOSGame.WIDTH/100)*20,((creditsImage.getY()-creditsImage.getHeight())-((credits_label.getHeight()))));
