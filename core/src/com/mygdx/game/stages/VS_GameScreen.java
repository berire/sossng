...
public class VS_GameScreen extends ScreenAdapter{
    ...
    public VS_GameScreen(final SOSGame game ) {
        this.game=game;
        //START: GUI PART
        ...
        humanPlayer2.setPosition((THEBOARD.getX()+(THEBOARD.getWidth()/100)*77),(THEBOARD.getY()+THEBOARD.getHeight())+(THEBOARD.getHeight()/5));
        humanPlayer2.setSize((SOSGame.WIDTH/100)*13 , (SOSGame.HEIGHT/100)*11);
    ...
    public void playSolo( ) {
                                     ...
                                     int button)
            {
                            ...
                            if (CELLS[i][g].isPressed() == true && board.cells[i][g].getValue() == Cell.CellValue.EMPTY && (choosenValue==Cell.CellValue.S_cell ||choosenValue==Cell.CellValue.O_cell))
                            {
                                ...
                                if(currentPlayer==p1) {
                                    ...
                                    if (choosenValue == Cell.CellValue.O_cell) {
                                        ...
                                        CELLS[i][g].setSize((THEBOARD.getHeight()/row/100)*92,(THEBOARD.getWidth()/column/100)*92);
                ...
                if(board.emptyCellPositions(board).size() == 0)
                {
                    ...
                    }else if(score2>score1)
                    {
                        ...
                        winn="The Winner is: "+winner.getName();
                        crown.setSize((SOSGame.WIDTH/100)*15 , (SOSGame.HEIGHT/100)*5);
                        crown.setPosition(humanPlayer2.getX()+((humanPlayer2.getWidth()-crown.getWidth())/2),(humanPlayer2.getY()+(humanPlayer2.getHeight())));
                        actorGroup.addActor(crown);
        ...
        p2name.setPosition((humanPlayer2.getX()+((humanPlayer2.getWidth()-p2name.getWidth())/2)),humanPlayer2.getY()-(p2name.getHeight()));


        if(Options.S_colors==Options.S_colors.Yellows)
        {p2name.setStyle(l2);}

        vs_stage.addActor(p1name);
        vs_stage.addActor(p2name);
    ...
    public void render ( float delta) {
        ...
        SOSGame.batch.draw(humanPlayer2,(THEBOARD.getX()+(THEBOARD.getWidth()/100)*77),(THEBOARD.getY()+THEBOARD.getHeight())+(THEBOARD.getHeight()/5),(SOSGame.WIDTH/100)*13, (SOSGame.HEIGHT/100)*11);
        other_font.setColor(Color.WHITE);

        other_font.draw(SOSGame.batch,ScoreName2,(humanPlayer2.getX()+((humanPlayer2.getWidth()-(ScoreName2.length()*4))/2)),p2name.getY()-(p2name.getHeight()/5));
