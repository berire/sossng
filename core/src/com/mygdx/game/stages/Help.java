...
public class Help extends ScreenAdapter{
    ...
    public Help(final SOSGame game)
    {
        ...
        helpImage.setPosition((SOSGame.WIDTH/100)*15,(SOSGame.HEIGHT/100)*85);
        ...
        helpLabel.setSize((SOSGame.WIDTH/100)*80,helpLabel.getMinHeight());
        ...
        helpTitle.setPosition((helpImage.getX()*6)/2,(helpImage.getY()+(helpImage.getHeight()/5)));
        helpLabel.setPosition((SOSGame.WIDTH/100)*20,((helpImage.getY()-helpImage.getHeight()*2)-((helpLabel.getHeight()))));
